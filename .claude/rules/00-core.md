...
| Understand / synthesize | `scout` agent (`routine` tier) |
...
| Code review | `code-reviewer` at `deep`, fresh context — never the session that wrote the code |
