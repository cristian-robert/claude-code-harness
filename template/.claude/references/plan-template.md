...
tier: deep                # implementer hint: `deep` (hard logic/architecture) | `build` (this plan already specs it out step by step). /review-branch inverts this to pick the reviewer.
---
